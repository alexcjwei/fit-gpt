...
/**
 * Create Express application with dependency injection
 * @param db - Kysely database instance to use for this app
 */
export function createApp(db: Kysely<Database>): Application {
  ...
  // API routes (with injected database)
...
// Default export for backward compatibility (uses global db connection)
import { db } from './db';
