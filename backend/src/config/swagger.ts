      ...
      schemas: {
        ...
        Workout: {
          ...
          properties: {
            ...
            startTime: { type: 'string', format: 'date-time', description: 'When workout was started' },
            lastModifiedTime: { type: 'string', format: 'date-time', description: 'Last modification timestamp' },
                        ...
                        sets: {
                          ...
                          items: {
                            ...
                            properties: {
                              ...
                              targetRepsMin: { type: 'integer', minimum: 0, description: 'Minimum reps in range' },
                              targetRepsMax: { type: 'integer', minimum: 0, description: 'Maximum reps in range' },
                              actualReps: { type: 'integer', minimum: 0 },
                              targetWeight: { type: 'number', minimum: 0 },
                              actualWeight: { type: 'number', minimum: 0 },
                              weightUnit: { type: 'string', enum: ['lbs', 'kg'] },
                              duration: { type: 'integer', minimum: 0, description: 'Duration in seconds for time-based exercises' },
                              rpe: { type: 'number', minimum: 1, maximum: 10, description: 'Rate of Perceived Exertion' },
