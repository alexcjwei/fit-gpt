          ...
          exercises: [
            {
              ...
              sets: [
                { setNumber: 1, targetRepsMin: 5, targetRepsMax: 5, completed: false, weightUnit: 'lbs' },
              ],
            },
          ],
        },
      ...
      blocks: [
        {
          exercises: [
            ...
            },
            {
              ...
              sets: [
                { setNumber: 1, targetRepsMin: 8, targetRepsMax: 8, completed: false, weightUnit: 'lbs' },
              ],
            },
          ],
        },
          ...
          exercises: [
            {
              ...
              sets: [
                { setNumber: 1, targetRepsMin: 10, targetRepsMax: 10, completed: false, weightUnit: 'lbs' },
              ],
            },
          ],
        },
